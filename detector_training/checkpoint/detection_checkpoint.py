# modified from https://github.com/facebookresearch/unbiased-teacher/blob/main/ubteacher/checkpoint/detection_checkpoint.py
...
class DetectionTSCheckpointer(DetectionCheckpointer):
    def _load_model(self, checkpoint):
        if checkpoint.get("__author__", None) in ["Caffe2", "MoCo", "Student_only"]:
            ...
            if checkpoint.get("matching_heuristics", False):
                ...
                align_and_update_state_dicts(
                    model_state_dict,
                    checkpoint["model"],
                    c2_conversion=checkpoint.get("__author__", None) in ["Caffe2", "MoCo"],
                )
