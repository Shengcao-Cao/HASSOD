# modified from https://github.com/facebookresearch/CutLER/blob/main/cutler/data/build.py and https://github.com/facebookresearch/unbiased-teacher/blob/main/ubteacher/data/build.py
...
from data.common import MapDatasetTwoCrop, AspectRatioGroupedDatasetTwoCrop, AspectRatioGroupedSemiSupDatasetTwoCrop
...
def build_detection_train_loader_two_crops(cfg, mapper=None):
    ...
    total_batch_size_label = cfg.SOLVER.IMS_PER_BATCH_LABEL
    total_batch_size_unlabel = cfg.SOLVER.IMS_PER_BATCH_UNLABEL
    aspect_ratio_grouping=cfg.DATALOADER.ASPECT_RATIO_GROUPING
    num_workers=cfg.DATALOADER.NUM_WORKERS
