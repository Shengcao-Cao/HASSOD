# modified from https://github.com/facebookresearch/CutLER/blob/main/cutler/data/datasets/builtin_meta.py
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name in ["ade20k", "entityseg", "paco", "partimagenet", "sa1b"]:
        return _get_imagenet_instances_meta()
