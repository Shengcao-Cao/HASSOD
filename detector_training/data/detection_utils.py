# modified from https://github.com/facebookresearch/CutLER/blob/main/cutler/data/detection_utils.py and https://github.com/facebookresearch/unbiased-teacher/blob/main/ubteacher/data/detection_utils.py
...
from data.transforms.augmentation_impl import (
    GaussianBlur,
)
...
def annotations_to_instances(annos, image_size, mask_format="polygon"):
    ...
    levels = [int(obj["hier_level"]) for obj in annos]
    levels = torch.tensor(levels, dtype=torch.int64)
    target.gt_levels = levels
